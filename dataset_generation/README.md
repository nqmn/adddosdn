...
-   `offline_dataset.csv`: A CSV file containing processed offline traffic data. This file is generated by `process_pcap_to_csv.py` from `traffic.pcap` and includes the following packet-level features:
...
-   `online_dataset.csv`: A CSV file containing flow statistics polled from the Ryu controller. This file includes the following flow-level features:
